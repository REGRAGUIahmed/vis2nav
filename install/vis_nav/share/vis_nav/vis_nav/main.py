...
def plot_animation_figure(env_name, lr_a, lr_c, ep_real, reward_target_list,
                          reward_collision_list, pedal_list, steering_list,
                          reward_list, reward_mean_list, reward_heuristic_list, reward_action_list, reward_freeze_list):
    ...
    plt.savefig('/home/regmed/dregmed/vis_to_nav/src/vis_nav/vis_nav/results/plot_24_1.png')
    plt.close(fig)
    ...
    plt.savefig('/home/regmed/dregmed/vis_to_nav/src/vis_nav/vis_nav/results/plot_24_2.png')
    plt.close(fig)
